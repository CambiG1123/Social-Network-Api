...
const seedDatabase = async () => {
  try {
    ...
    const thought1 = new Thought({
      thoughtText: 'This is the thought of user1',
      username: 'user1',
    });
    const thought2 = new Thought({
      thoughtText: 'This is the thought of user2',
      username: 'user2',
    });
    const thought3 = new Thought({
      thoughtText: 'This is the thought of user3',
      username: 'user3',
    });
    const thought4 = new Thought({
      thoughtText: 'This is the thought of user4',
      username: 'user4',
    });

    // Save thoughts to the database
    await Promise.all([thought1.save(), thought2.save(), thought3.save(), thought4.save()]);
    ...
    // Save updated users with friendships to the database
    await Promise.all([user1.save(), user2.save(), user3.save(), user4.save()]);
